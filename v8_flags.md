```
$ /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome  --js-flags="--help"
2017-03-16 19:49:22.895 Google Chrome[21966:149186] NSWindow warning: adding an unknown subview: <FullSizeContentView: 0x7fbec84a1810>. Break on NSLog to debug.
2017-03-16 19:49:22.895 Google Chrome[21966:149186] Call stack:
(
    "+callStackSymbols disabled for performance reasons"
)
[21970:775:0316/194923.199318:ERROR:child_thread_impl.cc(762)] Request for unknown Channel-associated interface: ui::mojom::GpuMain
...
Options:
  ...
  --harmony_class_fields (enable "harmony public fields in class literals" (in progress))
        type: bool  default: false
  --harmony_object_spread (enable "harmony object spread" (in progress))
        type: bool  default: false
  ...
  --mark_shared_functions_for_tier_up (mark shared functions for tier up)
        type: bool  default: false
  --trace_strong_rooted_literals (trace literal rooting)
        type: bool  default: false
  ...
  --turbo_preprocess_ranges (run pre-register allocation heuristics)
        type: bool  default: true
  --turbo_loop_stackcheck (enable stack checks in loops)
        type: bool  default: true
  ...
  --turbo_verify_machine_graph (verify TurboFan machine graph before instruction selection)
        type: string  default: NULL
  --csa_verify (verify TurboFan machine graph of code stubs)
        type: bool  default: false
  --trace_csa_verify (trace code stubs verification)
        type: bool  default: false
  ...
  --turbo_store_elimination (enable store-store elimination in TurboFan)
        type: bool  default: true
  --turbo_lower_create_closure (enable inline allocation for closure instantiation)
        type: bool  default: false
  ...
  --enable_liveedit (enable liveedit experimental feature)
        type: bool  default: true
  --side_effect_free_debug_evaluate (use side-effect-free debug-evaluate for testing)
        type: bool  default: false
